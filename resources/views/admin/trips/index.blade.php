    ...
    <div class="w-100">
        <div class="row">
            ...
            <div class="col-4 month_selector text-end">
                <a href="{{ route('admin.myTrips', ['uid' => '', 'date' => date('Y-m-d', strtotime($date . ' -1 month'))]) }}"><i class="fa fa-chevron-left"></i></a>
                @if (date('Y-m', strtotime($date)) != date('Y-m'))
                    <a href="{{ route('admin.myTrips', ['uid' => '', 'date' => date('Y-m-d', strtotime($date . ' +1 month'))]) }}"><i class="fa fa-chevron-right"></i></a>
                @else
