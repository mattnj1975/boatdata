    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modelHeading">+Admin</h4>
            ...
            <div class="modal-body">
                <form id="boatForm" name="boatForm" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-2 control-label">Admins</label>
                        <div class="col-sm-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="UserBoatForm" name="UserBoatForm" class="form-horizontal">
                    ...
                    <div class="modal-footer py-1">
                        <button id="closeModalBtn" type="button" class="btn btn-outline-primary">Close</button>
                        <button type="submit" class="btn btn-primary button-spinner" id="usersaveBtn" value="create">Submit</button>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.getElementById('UserBoatForm');
        ...
        function validateForm() {
            ...
            // Validate groups
            if (groupsInput.value.trim() === '') {
                usersError.textContent = 'Please Select Users';
                return false;
            }
